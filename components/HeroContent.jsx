            ...
            <div className={`hero-section ${AntonRegular.className} ${KhulaRegular.className}`}>
                <div className="desktop">
                    ...
                    <div className="desktop__name-and-photo">
                        ...
                        <img className="name-and-photo__photo" src="https://ik.imagekit.io/l9s2o85o5b/profile.png?updatedAt=1717636016869" alt="MikeyRG picture." width="385" height="385" id="picture"></img>
