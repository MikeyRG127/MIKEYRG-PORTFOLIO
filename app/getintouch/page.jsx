    ...
    return (
        <section className="getintouch">
            ...
            <div className="getintouch-box1">
                <span className="getintouch-box1__text1">GET IN</span>
                <span className="getintouch-box1__text1">TOUCH</span>
                <span className="getintouch-box1__text2">JOSEALBERTOPERSONAL@GMAIL.COM</span>
            </div>
